...
// This code is based on https://github.com/pipermerriam/ethereum-datetime
library Calendar {
        /*
        ...
        function distanceOnDays(uint from_timestamp, uint to_timestamp) public constant returns (uint) {
            require(from_timestamp < to_timestamp);
            uint distanceInSeconds = to_timestamp - from_timestamp;
            return distanceInSeconds/60/60/24;
        }
        ...
        function getDistanceInMonth(uint from_timestamp1, uint to_timestamp2) public constant returns (uint16) {
          uint16 year1 = getYear(from_timestamp1);
          uint16 year2 = getYear(to_timestamp2);
          uint16 month1 = getMonth(from_timestamp1);
          uint16 month2 = getMonth(to_timestamp2);
